...
const AutomaticCarousel = ({ images = [] }) => {
    ...
    return (
        <div className="relative w-full col-span-1 md:col-span-2 max-w-3xl mx-auto overflow-hidden rounded-lg shadow-lg bg-white mt-10">
        <div
            className="w-full flex transition-transform duration-700 ease-in-out h-48 sm:h-64 md:h-80"
        ...
        <div className="absolute bottom-3 w-full flex justify-center gap-2">
            ...
            <button
                ...
                index === i ? 'bg-green-700' : 'bg-gray-300'
                }`}
            ></button>
            ))}
        </div>
