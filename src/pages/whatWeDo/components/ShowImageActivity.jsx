export default function ShowImageActivity({ image, title = null, caption }) {
    return(
        <article className="flex flex-col h-full min-h-[400px] border-gray-300 rounded-lg shadow-md overflow-hidden">
            <div className="w-full h-70 md:h-64 lg:h-80 overflow-hidden rounded-lg mb-10">
            ...
            <p className="font-semibold text-center mb-4 px-2">{caption}</p>
        </article>
    );
}