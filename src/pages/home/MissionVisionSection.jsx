export default function MissionVisionSection({ image, title, paragraphs }) {
    return (
        <section className="flex flex-col justify-around md:justify-between h-full min-h-[500px] border border-gray-300 rounded-xl shadow-xl/20 overflow-hidden">
            <div className="w-full h-48 md:h-64 lg:h-72 overflow-hidden rounded-t-xl">
